...
{
    partial class Gelirgörüntülemesayfası
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Gelirgörüntülemesayfası));
            panel1 = new Panel();
            label7 = new Label();
            ...
            ((System.ComponentModel.ISupportInitialize)Görüntüleme).BeginInit();
            SuspendLayout();
            // 
            // panel1
            // 
            ...
            label7.Location = new Point(53, 748);
            label7.Name = "label7";
            ...
            pictureBox7.Location = new Point(13, 727);
            ...
            label6.Location = new Point(53, 520);
            label6.Name = "label6";
            ...
            pictureBox6.Location = new Point(13, 499);
            ...
            label5.Location = new Point(53, 448);
            label5.Name = "label5";
            ...
            pictureBox5.Location = new Point(13, 427);
            ...
            label4.Location = new Point(53, 370);
            label4.Name = "label4";
            ...
            pictureBox4.Location = new Point(13, 349);
            ...
            pictureBox3.Location = new Point(13, 270);
            ...
            pictureBox2.Location = new Point(13, 173);
            ...
            label13.Location = new Point(677, 76);
            label13.Name = "label13";
            label13.Size = new Size(233, 35);
            label13.TabIndex = 64;
            label13.Text = "Gelir Görüntüleme";
            // 
            // comboBox1
            // 
            comboBox1.Font = new Font("Arial", 12F, FontStyle.Regular, GraphicsUnit.Point);
            comboBox1.FormattingEnabled = true;
            comboBox1.Location = new Point(970, 171);
            ...
            // textBox1
            // 
            textBox1.Location = new Point(535, 171);
            ...
            label11.Location = new Point(376, 175);
            ...
            label10.Location = new Point(850, 175);
            ...
            pictureBox8.Location = new Point(1383, 0);
            ...
            // Görüntüleme
            // 
            Görüntüleme.AllowUserToAddRows = false;
            Görüntüleme.AllowUserToDeleteRows = false;
            Görüntüleme.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            Görüntüleme.BackgroundColor = Color.Gainsboro;
            Görüntüleme.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            Görüntüleme.Location = new Point(244, 291);
            Görüntüleme.Name = "Görüntüleme";
            Görüntüleme.ReadOnly = true;
            Görüntüleme.RowHeadersWidth = 51;
            Görüntüleme.RowTemplate.Height = 29;
            Görüntüleme.Size = new Size(1165, 495);
            Görüntüleme.TabIndex = 2;
            Görüntüleme.CellContentClick += Görüntüleme_CellContentClick;
            // 
            // Gelirgörüntülemesayfası
            // 
            AutoScaleDimensions = new SizeF(8F, 20F);
            AutoScaleMode = AutoScaleMode.Font;
            BackColor = Color.GhostWhite;
            ClientSize = new Size(1409, 786);
            Controls.Add(pictureBox8);
            Controls.Add(label13);
            Controls.Add(comboBox1);
            Controls.Add(Görüntüleme);
            Controls.Add(textBox1);
            Controls.Add(label11);
            Controls.Add(panel1);
            Controls.Add(label10);
            FormBorderStyle = FormBorderStyle.None;
            Name = "Gelirgörüntülemesayfası";
            StartPosition = FormStartPosition.CenterScreen;
            Text = "Gelirgörüntülemesayfası";
            Load += Gelirgörüntülemesayfası_Load;
            ...
            ((System.ComponentModel.ISupportInitialize)Görüntüleme).EndInit();
            ResumeLayout(false);
            PerformLayout();
        }
        ...
        private DataGridView Görüntüleme;
    }
}